(function($) {
	...
	function initContainer(div, options) {
        ...
        if(options.format == "minimal"){
            ...
            var parentTable = '<table style="background-color: #F8FCE6;" cellpadding="0" cellspacing="5"> ';
            parentTable += '<tbody> ';
            // Header
            parentTable += '<tr style="display:none"> ';
            ...
            // options table
            parentTable += '<tr> ';
            parentTable += '<td style="display:none" rowspan="'+rowspan+'" valign="top" id="optionsTable"> ';
            parentTable += '</td> ';

            // placeholder for sequence, m/z, scan number etc
            parentTable += '<td style="background-color: #F8FCE6; padding:5px; border:1px dotted #cccccc;" valign="bottom" align="center"> ';
            ...
            parentTable += '<td style="display:none" rowspan="'+rowspan+'" valign="top" id="ionTableLoc1" > ';
            ...
            parentTable += '<tr> ';
            parentTable += '<td style="background-color:#F8FCE6; padding:5px; border:1px dotted #cccccc;" valign="middle" align="center"> ';
            ...
            parentTable += '<div style="display:none" id="viewOptionsDiv" align="top" style="margin-top:15px;"></div> ';
            ...
            var parentTable = '<table style="background-color: white" cellpadding="0" cellspacing="5"> ';
            parentTable += '<tbody> ';
            // Header
            //parentTable += '<tr> ';
            //parentTable += '<td style="background-color: white;" colspan="3" class="bar"> ';
            //parentTable += '</div> ';
            //parentTable += '</td> ';
            //parentTable += '</tr> ';

            // options table
            parentTable += '<tr style="background-color: white;"> ';
            ...
            // placeholder for the ion table
            parentTable += '<td style="background-color: white;" rowspan="'+rowspan+'" valign="top" id="ionTableLoc1" > ';
            parentTable += '<div id="ionTableDiv">';
            //parentTable += '<span id="moveIonTable" class="font_small link">[Click]</span> <span class="font_small">to move table</span>';
            // placeholder for file name, scan number, modifications etc.
            parentTable += '<div id="modinfo" style="margin-top:5px;"></div> ';
            ...
            // Footer & placeholder for moving ion table
            //parentTable += '<tr> ';
            //parentTable += '<td style="background-color: white;" colspan="3" class="bar noprint" valign="top" align="center" id="ionTableLoc2" > ';
            //parentTable += '<div align="center" style="width:100%;font-size:10pt;"> ';
            //parentTable += '</div> ';
            //parentTable += '</td> ';
            //parentTable += '</tr> ';
